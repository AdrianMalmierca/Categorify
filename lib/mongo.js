...
const DB_USER = 'amartinmainf';
const DB_PASSWORD = 'lJeRfPo2IRdu4Tbk';
const DB_NAME = 'categorias';

const MONGO_URI = `mongodb+srv://${DB_USER}:${DB_PASSWORD}@serviciosplataformasweb.ry074.mongodb.net/${DB_NAME}?retryWrites=true&w=majority`;
